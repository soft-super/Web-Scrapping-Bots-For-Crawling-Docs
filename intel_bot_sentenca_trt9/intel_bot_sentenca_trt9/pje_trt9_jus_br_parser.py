...
BASE_URL = 'https://pje.trt9.jus.br/primeirograu/login.seam'
SEARCH_PAGE = 'https://pje.trt9.jus.br/primeirograu/Processo/ConsultaProcessoTerceiros/listView.seam'
...
if __name__ == '__main__':
    ...
    b.parse('0000847-76.2010.5.09.0001', search_words)
