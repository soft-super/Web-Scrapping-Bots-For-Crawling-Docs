...
BASE_URL = 'https://pje.trt8.jus.br/primeirograu/login.seam'
SEARCH_PAGE = 'https://pje.trt8.jus.br/primeirograu/Processo/ConsultaProcessoTerceiros/listView.seam'
...
if __name__ == '__main__':
    ...
    b.parse('0000693-29.2017.5.08.0005', search_words)
