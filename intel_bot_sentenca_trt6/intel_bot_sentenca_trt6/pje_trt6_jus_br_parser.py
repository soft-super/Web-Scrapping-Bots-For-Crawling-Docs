...
BASE_URL = 'https://pje.trt6.jus.br/primeirograu/login.seam'
SEARCH_PAGE = 'https://pje.trt6.jus.br/primeirograu/Processo/ConsultaProcessoTerceiros/listView.seam'
...
if __name__ == '__main__':
    ...
    b.parse('0010145-47.2013.5.06.0009', search_words)
