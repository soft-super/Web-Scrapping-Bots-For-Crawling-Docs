...
BASE_URL = 'https://pje.trt3.jus.br/primeirograu/login.seam'
SEARCH_PAGE = 'https://pje.trt3.jus.br/primeirograu/Processo/ConsultaProcessoTerceiros/listView.seam'
...
if __name__ == '__main__':
    ...
    b.parse('0035285.14.2018.8.13.0672', search_words)
