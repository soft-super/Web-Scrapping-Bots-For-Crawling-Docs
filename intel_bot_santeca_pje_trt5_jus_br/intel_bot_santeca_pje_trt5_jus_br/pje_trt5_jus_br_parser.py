...
BASE_URL = 'https://pje.trt5.jus.br/primeirograu/login.seam'
SEARCH_PAGE = 'https://pje.trt5.jus.br/primeirograu/Processo/ConsultaProcessoTerceiros/listView.seam'
...
if __name__ == '__main__':
    ...
    b.parse('0000992-24.2016.5.05.0005', search_words)
