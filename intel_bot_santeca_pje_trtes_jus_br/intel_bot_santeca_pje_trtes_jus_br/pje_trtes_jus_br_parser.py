...
BASE_URL = 'https://pje.trtes.jus.br/primeirograu/login.seam'
SEARCH_PAGE = 'https://pje.trtes.jus.br/primeirograu/Processo/ConsultaProcessoTerceiros/listView.seam'
...
if __name__ == '__main__':
    ...
    b.parse('0086300-07.2012.5.17.0014', search_words)
